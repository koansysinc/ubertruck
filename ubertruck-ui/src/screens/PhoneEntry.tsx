...
interface PhoneEntryProps {
  onSuccess: (sessionId: string, phoneNumber: string, otpExpiresIn: number, devOtp?: string) => void;
  onRegister?: () => void;
}
...
export const PhoneEntry: React.FC<PhoneEntryProps> = ({ onSuccess, onRegister }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      onSuccess(result.sessionId, phoneWithPrefix, result.otpExpiresIn, result.otp);
    } catch (err) {
