...
export const PriceBreakdown: React.FC<PriceBreakdownProps> = ({
  ...
  useEffect(() => {
    ...
    const targetTotal = priceCalculation.totalPrice;
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-xs text-gray-400">
              {priceCalculation.distance.toFixed(1)} km × {priceCalculation.cargoDetails?.weight || 0} tonnes @ ₹5/tonne/km
            </p>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4 pt-3 border-t">
          <div className="bg-gray-50 rounded-lg p-3">
            ...
            <p className="text-lg font-bold text-gray-900">{priceCalculation.distance.toFixed(1)} km</p>
          </div>
          <div className="bg-gray-50 rounded-lg p-3">
